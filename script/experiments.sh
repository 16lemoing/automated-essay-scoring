...
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 16 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 32 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 32 64 --device cuda

python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 16 --dropout 0.2 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 32 --dropout 0.2 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 32 64 --dropout 0.2 --device cuda

python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 16 --dropout 0.4 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 32 --dropout 0.4 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 32 64 --dropout 0.4 --device cuda

python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 16 --dropout 0.6 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 16 32 --dropout 0.6 --device cuda
python3 run_simulation.py --name conv --model_type conv --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --channel_sizes 16 32 64 --dropout 0.6 --device cuda
...
python3 run_simulation.py --name feat_only --model_type dense_feat --lr 0.01 --normalize_scores --batch_size 256 --correct_spelling --dim 300 --use_features --scale_features --hidden_size 300 128 --dropout 0.2 --remove_stopwords --device cuda